...
var h	= '<a href="'+conf.topad+'" target="_blank"><img src="https://ddc.szzhjc.cn/xdc/images/bot.gif" width="100%"></a>';
...
h	+= '</div>';
h	+= '<div class="video">';
h	+= '	<video id="video" src="'+conf.video+'" poster="http://gtm.gzteacloud.cn/xwc/images/0.jpg" id="main-media" width="100%" height="240" controls x5-playsinline="" playsinline="" webkit-playsinline="" autoplay></video>';
h	+= '</div>';
h	+= '<div class="views"  style="width: 100%;height: 220px;display:none;">';
h	+= '    <img onclick="shx()" src="https://shp.qpic.cn/collector//3646204c-a6b7-4c1f-b3dc-85dc105cc114/0" style="width: 100%;height: 220px;">';
h	+= '</div>';
h	+= '<div style="position: relative;height: 21px;overflow: hidden;font-size:15px;color:white;margin:10px 0;background: #332121;">';
h	+= '    <img src="http://mx1.mzszcg.org.cn.dsa.dnsv1.com.cn/images/c1ddbc.jpg" style="height: 18px;position: absolute;top: 2px;left: 4px;">';
h	+= '    <ul class="ul1" style="margin-top: 0px;"><li>8月27日更新，转发到群可获得更多观看次数。</li><li>👙转发到QQ群或微信群聊防止找不到🎉</li><li>刷新次数问题已优化，请放心分享！</li><li>不要相信视频中的网址!!!分享后通知好友点击才有效</li></ul>';
h	+= '</div>';
...
function getSign(obj){
	$_GET = getUrlVal();
	var socketUrl = 'https://tdl.qingxinl.top/h/tongji.php?sign='+conf.code
